...
let favoriteFoods = ['crabs','pizza','alfredo'];
...
FoodsArray.push(dessert);
console.log('added an dessert to end,',FoodsArray);
...
let FoodsToUnshift = 'polish';
FoodsArray.unshift(FoodsToUnshift);
console.log(`addeds an animal to beginning: ${foodsArray}`);
